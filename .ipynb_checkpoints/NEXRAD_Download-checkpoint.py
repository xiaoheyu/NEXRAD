...
## For NEXRAD raw data visulization, refer to the library pyart_env
...
########################################################################################################
def customized_download(date='2020/05/16',all_sites=['KFCX','KLVX','KAKQ']):
...
#     customized_download(date=mydate,all_sites = mysites)
    ...
    end_dt = datetime.date(2020,6,25)
